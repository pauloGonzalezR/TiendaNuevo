...
INSERT INTO `techshop`.`cliente` (`idcliente`, `nombre`, `apellidos`, `correo`, `telefono`) VALUES ('1', 'Juan', 'Castro Mora', 'jcastro@gmail.com', '4556-8978');
INSERT INTO `techshop`.`cliente` (`idcliente`, `nombre`, `apellidos`, `correo`, `telefono`) VALUES ('2', 'Ana', 'Contreras Mora', 'acontreras@gmail.com', '5456-8789');
INSERT INTO `techshop`.`cliente` (`idcliente`, `nombre`, `apellidos`, `correo`, `telefono`) VALUES ('3', 'Luis', 'Mena Loria', 'lmena@gmail.com', '7898-8936');
